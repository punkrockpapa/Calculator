...
$number.on('click', function() {
    ...
    $("#clear").css('background-color', '#fe7da4');
  ...
  if (currentNumber == 2) {
    ...
    $("#equal").css('background-color', '#fe7da4');
  }
});
      ...
      $("#clear").on('click', function()
        {
          ...
          currentNumber = 1;
          click = 0;
          $("#clear").css('background-color', '#FFB6C1');
          $("#equal").css('background-color', '#FFB6C1');
        });
